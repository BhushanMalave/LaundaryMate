...
import { HubCapacityDetailsTable } from "./HubCapacityDetailsTable";
import { useNavigate } from "react-router-dom";

export const HubCapacityDetails = () => {
  ...
  const [hubCapacityDetailData, sethubCapacityDetailData] = useState(obj);
