...
import "./CpuCapacityDeatilsTable.css";
...
const CpuCapacityDetailsTable = ({ data, rowsPerPage, tableHeader, cpuId }) => {
            ...
            <>
              ...
              >
                <td
                  ...
                  onClick={(e) => {
                    e.stopPropagation();
                    navigate("/CpuCapacityDetailsInfo", {
...
export default CpuCapacityDetailsTable;
